...
#import "VMCustomLocationViewController.h"

@interface MBXCustomLocationManager : NSObject<VMGLLocationManager>
@end
...
@property (strong, nonatomic) VMGLMapView *mapView;
...
- (void)viewDidLoad {
    ...
    self.mapView = [[VMGLMapView alloc] initWithFrame:self.view.bounds];
