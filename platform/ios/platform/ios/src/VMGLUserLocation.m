...
@implementation VMGLUserLocation
...
- (BOOL)isEqual:(id)other {
    ...
    if (![other isKindOfClass:[VMGLUserLocation class]]) return NO;

    VMGLUserLocation *otherUserLocation = other;
...
- (BOOL)isUpdating
{
    return self.mapView.userTrackingMode != VMGLUserTrackingModeNone;
}
