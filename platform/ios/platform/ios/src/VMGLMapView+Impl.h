...
class VMGLMapViewImpl : public mbgl::MapObserver {
public:
    static std::unique_ptr<VMGLMapViewImpl> Create(VMGLMapView*);

    VMGLMapViewImpl(VMGLMapView*);
    virtual ~VMGLMapViewImpl() = default;
...
protected:
    ...
    __weak VMGLMapView *mapView = nullptr;
};
