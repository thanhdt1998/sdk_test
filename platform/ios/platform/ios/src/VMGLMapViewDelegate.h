...
#import "Mapbox.h"
#import "VMGLCameraChangeReason.h"
 ...
 */
@protocol VMGLMapViewDelegate <NSObject>
 ...
 */
- (BOOL)mapView:(VMGLMapView *)mapView shouldChangeFromCamera:(VMGLMapCamera *)oldCamera toCamera:(VMGLMapCamera *)newCamera reason:(VMGLCameraChangeReason)reason;
 ...
 */
- (void)mapView:(VMGLMapView *)mapView regionWillChangeAnimated:(BOOL)animated;
 ...
 */
- (void)mapView:(VMGLMapView *)mapView regionWillChangeWithReason:(VMGLCameraChangeReason)reason animated:(BOOL)animated;
 ...
 */
- (void)mapView:(VMGLMapView *)mapView regionIsChangingWithReason:(VMGLCameraChangeReason)reason;
 ...
 */
- (void)mapView:(VMGLMapView *)mapView regionDidChangeAnimated:(BOOL)animated;
 ...
 */
- (void)mapViewWillStartLoadingMap:(VMGLMapView *)mapView;
 ...
 */
- (void)mapViewDidFinishLoadingMap:(VMGLMapView *)mapView;
 ...
 */
- (void)mapViewDidFailLoadingMap:(VMGLMapView *)mapView withError:(NSError *)error;

// TODO
- (void)mapViewWillStartRenderingMap:(VMGLMapView *)mapView;

// TODO
- (void)mapViewDidFinishRenderingMap:(VMGLMapView *)mapView fullyRendered:(BOOL)fullyRendered;
 ...
 */
- (void)mapViewWillStartRenderingFrame:(VMGLMapView *)mapView;
 ...
 */
- (void)mapViewDidBecomeIdle:(VMGLMapView *)mapView;
...
- (nullable UIImage *)mapView:(VMGLMapView *)mapView didFailToLoadImage:(NSString *)imageName;
...
/**
 ...
 the cached image.
 */
- (BOOL)mapView:(VMGLMapView *)mapView shouldRemoveStyleImage:(NSString *)imageName;
 ...
 */
- (void)mapViewWillStartLocatingUser:(VMGLMapView *)mapView;
...
/**
 ...
 @param mapView The map view that is tracking the user’s location.
 */
- (void)mapViewDidStopLocatingUser:(VMGLMapView *)mapView;
...
/**
 ...
 @param mapView The map view that is tracking the user’s location.
 */
- (MGLUserLocationAnnotationViewStyle *)mapViewStyleForDefaultUserLocationAnnotationView:(VMGLMapView *)mapView NS_SWIFT_NAME(mapView(styleForDefaultUserLocationAnnotationView:));
 ...
 */
- (void)mapView:(VMGLMapView *)mapView didUpdateUserLocation:(nullable VMGLUserLocation *)userLocation;
...
/**
 ...
 @param error An error object containing the reason why location tracking
    failed.
 */
- (void)mapView:(VMGLMapView *)mapView didFailToLocateUserWithError:(NSError *)error;
...
/**
 ...
 @param animated Whether the change caused an animated effect on the map.
 */
- (void)mapView:(VMGLMapView *)mapView didChangeUserTrackingMode:(VMGLUserTrackingMode)mode animated:(BOOL)animated;
...
/**
 ...
 @param mapView The map view that is tracking the user's location.
 */
- (CGPoint)mapViewUserLocationAnchorPoint:(VMGLMapView *)mapView;
 ...
 */
- (void)mapView:(VMGLMapView *)mapView didChangeLocationManagerAuthorization:(id<VMGLLocationManager>)manager API_AVAILABLE(ios(14));
...
/**
 ...
 your map.
 */
- (nullable VMGLAnnotationImage *)mapView:(VMGLMapView *)mapView imageForAnnotation:(id <VMGLAnnotation>)annotation;
 ...
 */
- (CGFloat)mapView:(VMGLMapView *)mapView alphaForShapeAnnotation:(VMGLShape *)annotation;
 ...
 */
- (UIColor *)mapView:(VMGLMapView *)mapView strokeColorForShapeAnnotation:(VMGLShape *)annotation;
 ...
 */
- (UIColor *)mapView:(VMGLMapView *)mapView fillColorForPolygonAnnotation:(VMGLPolygon *)annotation;
 ...
 */
- (CGFloat)mapView:(VMGLMapView *)mapView lineWidthForPolylineAnnotation:(VMGLPolyline *)annotation;
...
/**
 ...
 map.
 */
- (nullable VMGLAnnotationView *)mapView:(VMGLMapView *)mapView viewForAnnotation:(id <VMGLAnnotation>)annotation;
 ...
 */
- (void)mapView:(VMGLMapView *)mapView didAddAnnotationViews:(NSArray<VMGLAnnotationView *> *)annotationViews;
 ...
 */
- (BOOL)mapView:(VMGLMapView *)mapView shapeAnnotationIsEnabled:(VMGLShape *)annotation;
 ...
 */
- (void)mapView:(VMGLMapView *)mapView didSelectAnnotation:(id <VMGLAnnotation>)annotation;
 ...
 */
- (void)mapView:(VMGLMapView *)mapView didDeselectAnnotation:(id <VMGLAnnotation>)annotation;
 ...
 */
- (void)mapView:(VMGLMapView *)mapView didSelectAnnotationView:(VMGLAnnotationView *)annotationView;
 ...
 */
- (void)mapView:(VMGLMapView *)mapView didDeselectAnnotationView:(VMGLAnnotationView *)annotationView;
 ...
 */
- (BOOL)mapView:(VMGLMapView *)mapView annotationCanShowCallout:(id <VMGLAnnotation>)annotation;
 ...
 */
- (nullable id <VMGLCalloutView>)mapView:(VMGLMapView *)mapView calloutViewForAnnotation:(id <VMGLAnnotation>)annotation;
 ...
 */
- (nullable UIView *)mapView:(VMGLMapView *)mapView leftCalloutAccessoryViewForAnnotation:(id <VMGLAnnotation>)annotation;
 ...
 */
- (nullable UIView *)mapView:(VMGLMapView *)mapView rightCalloutAccessoryViewForAnnotation:(id <VMGLAnnotation>)annotation;
 ...
 */
- (void)mapView:(VMGLMapView *)mapView annotation:(id <VMGLAnnotation>)annotation calloutAccessoryControlTapped:(UIControl *)control;
