...
@class VMGLAnnotationImage;
@class VMGLUserLocation;
@class VMGLMapProjection;
@class VMGLPolyline;
@class VMGLPolygon;
@class VMGLShape;

@protocol VMGLMapViewDelegate;
@protocol VMGLAnnotation;
@protocol VMGLOverlay;
@protocol VMGLCalloutView;
@protocol VMGLFeature;
@protocol VMGLLocationManager;

/** Options for `VMGLMapView.decelerationRate`. */
typedef CGFloat VMGLMapViewDecelerationRate NS_TYPED_EXTENSIBLE_ENUM;

/** The default deceleration rate for a map view. */
FOUNDATION_EXTERN MGL_EXPORT const VMGLMapViewDecelerationRate VMGLMapViewDecelerationRateNormal;

/** A fast deceleration rate for a map view. */
FOUNDATION_EXTERN MGL_EXPORT const VMGLMapViewDecelerationRate VMGLMapViewDecelerationRateFast;

/** Disables deceleration in a map view. */
FOUNDATION_EXTERN MGL_EXPORT const VMGLMapViewDecelerationRate VMGLMapViewDecelerationRateImmediate;

/**
 The vertical alignment of an annotation within a map view. Used with
 `VMGLMapView.userLocationVerticalAlignment`.
 */
typedef NS_ENUM(NSUInteger, VMGLAnnotationVerticalAlignment) {
    /** Aligns the annotation vertically in the center of the map view. */
    VMGLAnnotationVerticalAlignmentCenter = 0,
    /** Aligns the annotation vertically at the top of the map view. */
    VMGLAnnotationVerticalAlignmentTop,
    /** Aligns the annotation vertically at the bottom of the map view. */
    VMGLAnnotationVerticalAlignmentBottom,
};

/**
 The position of scale bar, compass, logo and attribution in a map view. Used with
 `VMGLMapView.scaleBarPosition`,
 `VMGLMapView.compassViewPosition`,
 `VMGLMapView.logoViewPosition`,
 `VMGLMapView.attributionButtonPosition`.
 */
typedef NS_ENUM(NSUInteger, VMGLOrnamentPosition) {
    /** Place the ornament in the top left of the map view. */
    VMGLOrnamentPositionTopLeft = 0,
 ...
 */
typedef NS_ENUM(NSUInteger, VMGLUserTrackingMode) {
    /** The map does not follow the user location. */
    VMGLUserTrackingModeNone              = 0,
    /** The map follows the user location. This tracking mode falls back
        to `VMGLUserTrackingModeNone` if the user pans the map view. */
    VMGLUserTrackingModeFollow,
    /**
        ...
        view, this tracking mode will fall back to `VMGLUserTrackingModeFollow`.
     */
    VMGLUserTrackingModeFollowWithHeading,
    /**
        ...
        this tracking mode will fall back to `VMGLUserTrackingModeFollow`.
     */
    VMGLUserTrackingModeFollowWithCourse,
};

typedef NS_ENUM(NSUInteger, VMGLPanScrollingMode) {
    /** The map allows the user to only scroll horizontally. */
    VMGLPanScrollingModeHorizontal               = 0,
    /** The map allows the user to only scroll vertically. */
    VMGLPanScrollingModeVertical,
    /** The map allows the user to scroll both horizontally and vertically. */
    VMGLPanScrollingModeDefault
};

/** Options for `VMGLMapView.preferredFramesPerSecond`. */
typedef NSInteger VMGLMapViewPreferredFramesPerSecond NS_TYPED_EXTENSIBLE_ENUM;

/**
 The default frame rate. This can be either 30 FPS or 60 FPS, depending on
 device capabilities.
 */
FOUNDATION_EXTERN MGL_EXPORT const VMGLMapViewPreferredFramesPerSecond VMGLMapViewPreferredFramesPerSecondDefault;

/** A conservative frame rate; typically 30 FPS. */
FOUNDATION_EXTERN MGL_EXPORT const VMGLMapViewPreferredFramesPerSecond VMGLMapViewPreferredFramesPerSecondLowPower;

/** The maximum supported frame rate; typically 60 FPS. */
FOUNDATION_EXTERN MGL_EXPORT const VMGLMapViewPreferredFramesPerSecond VMGLMapViewPreferredFramesPerSecondMaximum;

FOUNDATION_EXTERN MGL_EXPORT VMGLExceptionName const VMGLMissingLocationServicesUsageDescriptionException;
FOUNDATION_EXTERN MGL_EXPORT VMGLExceptionName const VMGLUserLocationAnnotationTypeException;

/**
 An interactive, customizable map view with an interface similar to the one
 provided by Apple’s MapKit.

 Using `VMGLMapView`, you can embed the map inside a view, allow users to
 ...
 A collection of Mapbox-hosted styles is available through the `VMGLStyle`
 ...
 Because `VMGLMapView` loads asynchronously, several delegate methods are available
 ...
 in the `VMGLMapViewDelegate` protocol documentation.

 Adding your own gesture recognizer to `VMGLMapView` will block the corresponding
 gesture recognizer built into `VMGLMapView`. To avoid conflicts, define which
 gesture takes precedence. For example, you can create your own
 `UITapGestureRecognizer` that will be invoked only if the default `VMGLMapView`
 tap gesture fails:
 ...
 Simple map view</a> example to learn how to initialize a basic `VMGLMapView`.
 */
MGL_EXPORT
@interface VMGLMapView : UIView <VMGLStylable>
...
/**
 ...
 initialize an `VMGLMapView` with a custom style. See the
 ...
 an `VMGLMapView` with a Studio Classic style _or_ a custom style JSON. See the
 ...
 `VMGLMapView` with a third-party tile source.
 */
...
/**
 ...
 annotations.
 */
@property(nonatomic, weak, nullable) IBOutlet id<VMGLMapViewDelegate> delegate;
...
/**
 ...
 `-[VMGLMapViewDelegate mapView:didFinishLoadingStyle:]` or
 `-[VMGLMapViewDelegate mapViewDidFinishLoadingMap:]` method. It is not possible
 ...
 @note The default styles provided by Mapbox contain sources and layers with
    ...
    `+[VMGLStyle outdoorsStyleURLWithVersion:]`, `VMGLMapView`’s “Style URL”
...
/**
 The position of the scale bar. The default value is `VMGLOrnamentPositionTopLeft`.
 */
@property (nonatomic, assign) VMGLOrnamentPosition scaleBarPosition;
 ...
 */
@property (nonatomic, readonly) VMGLCompassButton *compassView;

/**
 The position of the compass view. The default value is `VMGLOrnamentPositionTopRight`.
 */
@property (nonatomic, assign) VMGLOrnamentPosition compassViewPosition;
...
/**
 The position of the logo view. The default value is `VMGLOrnamentPositionBottomLeft`.
 */
@property (nonatomic, assign) VMGLOrnamentPosition logoViewPosition;
...
/**
 The position of the attribution button. The default value is `VMGLOrnamentPositionBottomRight`.
 */
@property (nonatomic, assign) VMGLOrnamentPosition attributionButtonPosition;
...
/**
 ...
 `VMGLMapViewPreferredFramesPerSecondDefault`, which will adaptively set the
 preferred frame rate based on the capability of the user’s device to maintain
 a smooth experience.

 In addition to the provided `VMGLMapViewPreferredFramesPerSecond` options, this
 property can be set to arbitrary integer values.

 @see `CADisplayLink.preferredFramesPerSecond`
 */
@property (nonatomic, assign) VMGLMapViewPreferredFramesPerSecond preferredFramesPerSecond;
...
/**
 ...
 `-[VMGLMapViewDelegate mapView:didUpdateUserLocation:]` and
 `-[VMGLMapViewDelegate mapView:didFailToLocateUserWithError:]` methods.

 If setting this property to `nil` or if no custom manager is provided this
 property is set to the default location manager.

 `VMGLMapView` uses a default location manager. If you want to substitute your
 ...
 */
@property (nonatomic, null_resettable) id<VMGLLocationManager> locationManager;
 ...
 */
@property (nonatomic, readonly, nullable) VMGLUserLocation *userLocation;

/**
 The mode used to track the user location. The default value is
 `VMGLUserTrackingModeNone`.
 ...
 default user location annotation shown by `VMGLUserTrackingMode`.
 */
@property (nonatomic, assign) VMGLUserTrackingMode userTrackingMode;
 ...
 */
- (void)setUserTrackingMode:(VMGLUserTrackingMode)mode animated:(BOOL)animated __attribute__((deprecated("Use `-setUserTrackingMode:animated:completionHandler:` instead.")));
...
/**
 ...
 default value is `VMGLAnnotationVerticalAlignmentCenter`.

 Changing the value of this property updates the map view with an animated
 transition. If you don’t want to animate the change, use the
 `-setUserLocationVerticalAlignment:animated:` method instead.
 */
@property (nonatomic, assign) VMGLAnnotationVerticalAlignment userLocationVerticalAlignment __attribute__((deprecated("Use `-[VMGLMapViewDelegate mapViewUserLocationAnchorPoint:]` instead.")));
 ...
 */
- (void)setUserLocationVerticalAlignment:(VMGLAnnotationVerticalAlignment)alignment animated:(BOOL)animated __attribute__((deprecated("Use `-[VMGLMapViewDelegate mapViewUserLocationAnchorPoint:]` instead.")));
...
/**
 ...
 `VMGLUserTrackingModeFollowWithHeading` or
 `VMGLUserTrackingModeFollowWithCourse`.
...
/**
 ...
 value other than `VMGLUserTrackingModeFollowWithCourse`.
...
/**
 ...
 other than `VMGLUserTrackingModeFollowWithCourse`.
...
`VMGLPanScrollingModeHorizontal` only allows the user to scroll horizontally on the map,
 restricting a user's ability to scroll vertically.
`VMGLPanScrollingModeVertical` only allows the user to scroll vertically on the map,
 restricting a user's ability to scroll horizontally.
 `VMGLPanScrollingModeDefault` allows the user to scroll both horizontally and vertically
 on the map.

 By default, this property is set to `VMGLPanScrollingModeDefault`.
 */
@property (nonatomic, assign) VMGLPanScrollingMode panScrollingMode;
...
/**
 ...
 Your application can use the `VMGLMapViewDecelerationRateNormal` and
 `VMGLMapViewDecelerationRateFast` constants as reference points for reasonable
 deceleration rates. `VMGLMapViewDecelerationRateImmediate` can be used to
 ...
 */
@property (nonatomic) VMGLCoordinateBounds visibleCoordinateBounds;
 ...
 */
- (void)setVisibleCoordinateBounds:(VMGLCoordinateBounds)bounds edgePadding:(UIEdgeInsets)insets animated:(BOOL)animated __attribute__((deprecated("Use `-setVisibleCoordinateBounds:edgePadding:animated:completionHandler:` instead.")));
...
/**
 ...
 @param animated `YES` if you want the map region change to be animated, or `NO`
    if you want the map to display the new region immediately without animations.
 */
- (void)showAnnotations:(NSArray<id <VMGLAnnotation>> *)annotations edgePadding:(UIEdgeInsets)insets animated:(BOOL)animated __attribute__((deprecated("Use `-showAnnotations:edgePadding:animated:completionHandler:` instead.")));
 ...
 */
@property (nonatomic, copy) VMGLMapCamera *camera;
...
/**
 ...
 If the `userTrackingMode` property is not `VMGLUserTrackingModeNone`, the
...
/**
 ...
 use the map view’s property `VMGLMapView.automaticallyAdjustsContentInset`instead.
...
/**
 ...
 The objects in this array must adopt the `VMGLAnnotation` protocol. If no
 annotations are associated with the map view, the value of this property is
 `nil`.
 */
@property (nonatomic, readonly, nullable) NSArray<id <VMGLAnnotation>> *annotations;

/**
 Adds an annotation to the map view.

 @note `VMGLMultiPolyline`, `VMGLMultiPolygon`, `VMGLShapeCollection`, and
    `VMGLPointCollection` objects cannot be added to the map view at this time.
 ...
 @param annotation The annotation object to add to the receiver. This object
    must conform to the `VMGLAnnotation` protocol. The map view retains the
    annotation object.
 ...
 annotation to an `VMGLMapView` object.
 */
...
/**
 ...
 @note `VMGLMultiPolyline`, `VMGLMultiPolygon`, and `VMGLShapeCollection` objects
    cannot be added to the map view at this time. Nor can `VMGLMultiPoint`
    objects that are not instances of `VMGLPolyline` or `VMGLPolygon`. Any
    multipoint, multipolyline, multipolygon, or shape collection objects that
    are specified are silently ignored.

 @param annotations An array of annotation objects. Each object in the array
    must conform to the `VMGLAnnotation` protocol. The map view retains each
...
/**
 ...
 @param annotation The annotation object to remove. This object must conform
    to the `VMGLAnnotation` protocol
 */
...
/**
 ...
 @param annotations The array of annotation objects to remove. Objects in the
    array must conform to the `VMGLAnnotation` protocol.
 */
- (void)removeAnnotations:(NSArray<id <VMGLAnnotation>> *)annotations;

/**
 Returns an `VMGLAnnotationView` if the given annotation is currently associated
 with a view, otherwise nil.

 @param annotation The annotation associated with the view.
    Annotation must conform to the `VMGLAnnotation` protocol.
 */
...
/**
 ...
 For performance reasons, you should generally reuse `VMGLAnnotationImage`
 ...
 reuse an `VMGLAnnotationImage`.
 */
- (nullable __kindof VMGLAnnotationImage *)dequeueReusableAnnotationImageWithIdentifier:(NSString *)identifier;

/**
 Returns a reusable annotation view object associated with its identifier.

 For performance reasons, you should generally reuse `VMGLAnnotationView`
 objects for identical-looking annotations in your map views. Dequeueing
 saves time and memory during performance-critical operations such as
 scrolling.
 ...
 @return An annotation view object with the given identifier, or `nil` if no
    such object exists in the reuse queue.
 */
- (nullable __kindof VMGLAnnotationView *)dequeueReusableAnnotationViewWithIdentifier:(NSString *)identifier;
 ...
 */
@property (nonatomic, readonly, nullable) NSArray<id <VMGLAnnotation>> *visibleAnnotations;
...
/**
 ...
 @return An array of objects that adopt the `VMGLAnnotation` protocol or `nil` if
...
/**
 ...
 If the annotation is of type `VMGLPointAnnotation` and is offscreen, the camera
 ...
 selected.
 */
@property (nonatomic, copy) NSArray<id <VMGLAnnotation>> *selectedAnnotations;
...
/**
 ...
 | `YES`            | The annotation is selected, and the callout is presented. If the annotation is not visible (or is partially visible) *and* is of type `VMGLPointAnnotation`, the map is panned so that the annotation and its callout are brought into view. The annotation is *not* centered within the viewport. |
 ...
 change the camera.
 */
- (void)selectAnnotation:(id <VMGLAnnotation>)annotation animated:(BOOL)animated __attribute__((deprecated("Use `-selectAnnotation:animated:completionHandler:` instead.")));
...
/**
 ...
 @param annotation The annotation object to select.
 @param moveIntoView If the annotation is not visible (or is partially visible) *and* is of type `VMGLPointAnnotation`, the map is panned so that the annotation and its callout are brought into view. The annotation is *not* centered within the viewport.
 ...
 */
- (void)deselectAnnotation:(nullable id <VMGLAnnotation>)annotation animated:(BOOL)animated;
...
/**
 ...
 The objects in this array must adopt the `VMGLOverlay` protocol. If no
 overlays are associated with the map view, the value of this property is
 empty array.
 */
@property (nonatomic, readonly, nonnull) NSArray<id <VMGLOverlay>> *overlays;
...
/**
 ...
 @param overlays An array of objects, each of which conforms to the `VMGLOverlay`
    protocol.
 */
...
/**
 ...
 @return An array of objects conforming to the `VMGLFeature` protocol that
 ...
 `VMGLMapView` object for visible `VMGLFeature` objects.
 */
- (NSArray<id <VMGLFeature>> *)visibleFeaturesAtPoint:(CGPoint)point NS_SWIFT_NAME(visibleFeatures(at:));
...
/**
 ...
 @return An array of objects conforming to the `VMGLFeature` protocol that
    represent features in the sources used by the current style.
 */
- (NSArray<id <VMGLFeature>> *)visibleFeaturesAtPoint:(CGPoint)point inStyleLayersWithIdentifiers:(nullable NSSet<NSString *> *)styleLayerIdentifiers NS_SWIFT_NAME(visibleFeatures(at:styleLayerIdentifiers:));
...
/**
 ...
 `VMGLShapeSource` and `VMGLVectorTileSource` objects but does not include
 anything from `VMGLRasterTileSource` objects, or from video or canvas sources,
 ...
 `VMGLFeature` object representing that bus stop is returned and its
 ...
 visibility, use the
 `-[VMGLVectorTileSource featuresInSourceLayersWithIdentifiers:predicate:]` and
 `-[VMGLShapeSource featuresMatchingPredicate:]` methods on the relevant sources.

 The returned features may also include features corresponding to annotations.
 These features are not object-equal to the `VMGLAnnotation` objects that were
 originally added to the map. To query the map for annotations, use
 `visibleAnnotations` or `-[VMGLMapView visibleAnnotationsInRect:]`.

 @note Layer identifiers are not guaranteed to exist across styles or different
    versions of the same style. Applications that use this API must first set
    the style URL to an explicitly versioned style using a convenience method
    like `+[VMGLStyle outdoorsStyleURLWithVersion:]`, `VMGLMapView`’s “Style URL”
 ...
 @return An array of objects conforming to the `VMGLFeature` protocol that
    represent features in the sources used by the current style.
 */
- (NSArray<id <VMGLFeature>> *)visibleFeaturesAtPoint:(CGPoint)point inStyleLayersWithIdentifiers:(nullable NSSet<NSString *> *)styleLayerIdentifiers predicate:(nullable NSPredicate *)predicate NS_SWIFT_NAME(visibleFeatures(at:styleLayerIdentifiers:predicate:));
...
/**
 ...
 @return An array of objects conforming to the `VMGLFeature` protocol that
    represent features in the sources used by the current style.
 */
- (NSArray<id <VMGLFeature>> *)visibleFeaturesInRect:(CGRect)rect NS_SWIFT_NAME(visibleFeatures(in:));
...
/**
 ...
 @return An array of objects conforming to the `VMGLFeature` protocol that
    represent features in the sources used by the current style.
 */
- (NSArray<id <VMGLFeature>> *)visibleFeaturesInRect:(CGRect)rect inStyleLayersWithIdentifiers:(nullable NSSet<NSString *> *)styleLayerIdentifiers NS_SWIFT_NAME(visibleFeatures(in:styleLayerIdentifiers:));
...
/**
 ...
 array. On the other hand, if the style does include bus stops, an `VMGLFeature`
 ...
 @return An array of objects conforming to the `VMGLFeature` protocol that
    represent features in the sources used by the current style.
 */
- (NSArray<id <VMGLFeature>> *)visibleFeaturesInRect:(CGRect)rect inStyleLayersWithIdentifiers:(nullable NSSet<NSString *> *)styleLayerIdentifiers predicate:(nullable NSPredicate *)predicate NS_SWIFT_NAME(visibleFeatures(in:styleLayerIdentifiers:predicate:));
