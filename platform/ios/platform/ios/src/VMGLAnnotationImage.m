...
@implementation VMGLAnnotationImage
...
- (BOOL)isEqual:(id)other {
    ...
    if (![other isKindOfClass:[VMGLAnnotationImage class]]) return NO;

    VMGLAnnotationImage *otherAnnotationImage = other;
