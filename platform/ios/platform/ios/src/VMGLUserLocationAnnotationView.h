...
MGL_EXPORT
@interface VMGLUserLocationAnnotationView : VMGLAnnotationView
 ...
 */
@property (nonatomic, readonly, weak, nullable) VMGLMapView *mapView;
 ...
 */
@property (nonatomic, readonly, weak, nullable) VMGLUserLocation *userLocation;
