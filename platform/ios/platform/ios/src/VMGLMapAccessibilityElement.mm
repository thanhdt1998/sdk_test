...
@implementation VMGLAnnotationAccessibilityElement

- (instancetype)initWithAccessibilityContainer:(id)container tag:(VMGLAnnotationTag)tag {
...
@implementation VMGLFeatureAccessibilityElement

- (instancetype)initWithAccessibilityContainer:(id)container feature:(id<VMGLFeature>)feature {
    if (self = [super initWithAccessibilityContainer:container]) {
        _feature = feature;
...
@implementation VMGLPlaceFeatureAccessibilityElement
...
@implementation VMGLRoadFeatureAccessibilityElement
...
- (instancetype)initWithAccessibilityContainer:(id)container feature:(id<VMGLFeature>)feature {
    if (self = [super initWithAccessibilityContainer:container feature:feature]) {
        ...
        VMGLPolyline *polyline;
        if ([feature isKindOfClass:[VMGLMultiPolylineFeature class]]) {
            ...
            polyline = [(VMGLMultiPolylineFeature *)feature polylines].firstObject;
        }
        
        // Announce the road’s general direction.
        if ([feature isKindOfClass:[VMGLPolylineFeature class]]) {
            polyline = (VMGLPolylineFeature *)feature;
        }
        if (polyline) {
...
@implementation VMGLMapViewProxyAccessibilityElement
