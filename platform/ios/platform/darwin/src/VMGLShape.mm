...
@implementation VMGLShape

+ (nullable VMGLShape *)shapeWithData:(NSData *)data encoding:(NSStringEncoding)encoding error:(NSError * _Nullable *)outError {
    ...
    try {
        ...
        return VMGLShapeFromGeoJSON(geojson);
...
- (BOOL)isEqual:(id)other
{
    ...
    id <VMGLAnnotation> annotation = other;
