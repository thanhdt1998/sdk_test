 ...
 */
- (NSURLSession *)sessionForNetworkConfiguration:(VMGLNetworkConfiguration *)configuration;
@end
 ...
 */
MGL_EXPORT
@interface VMGLNetworkConfiguration : NSObject
 ...
 */
@property (class, nonatomic, readonly) VMGLNetworkConfiguration *sharedManager;
