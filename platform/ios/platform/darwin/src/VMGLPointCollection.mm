...
@implementation VMGLPointCollection
{
...
- (BOOL)isEqual:(id)other {
    ...
    if (![other isKindOfClass:[VMGLPointCollection class]]) return NO;

    VMGLPointCollection *otherCollection = (VMGLPointCollection *)other;
