...
/**
 ...
 dependent way.
 */
class VMGLRenderFrontend : public mbgl::RendererFrontend
{
public:
    VMGLRenderFrontend(std::unique_ptr<mbgl::Renderer> renderer_, VMGLMapView* nativeView_, mbgl::gfx::RendererBackend& mbglBackend_, bool async = false)
...
private:
    ...
    __weak VMGLMapView *nativeView = nullptr;
