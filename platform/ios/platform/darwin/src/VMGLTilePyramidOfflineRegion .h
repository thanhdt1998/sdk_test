 ...
 */
MGL_EXPORT
@interface VMGLTilePyramidOfflineRegion  : NSObject <VMOfflineRegion, NSSecureCoding, NSCopying>

/**
 The coordinate bounds for the geographic region covered by the downloaded
 tiles.
 */
@property (nonatomic, readonly) VMGLCoordinateBounds bounds;
...
/**
 ...
 @param maximumZoomLevel The maximum zoom level to be covered by the downloaded
    ...
    level.
 */
- (instancetype)initWithStyleURL:(nullable NSURL *)styleURL bounds:(VMGLCoordinateBounds)bounds fromZoomLevel:(double)minimumZoomLevel toZoomLevel:(double)maximumZoomLevel NS_DESIGNATED_INITIALIZER;
