...
const VMGLExceptionName MGLInvalidStyleSourceException = @"MGLInvalidStyleSourceException";

@interface VMGLSource ()
...
- (instancetype)initWithRawSource:(mbgl::style::Source *)rawSource stylable:(id <VMGLStylable>)stylable {
...
- (void)addToStylable:(id <VMGLStylable>)stylable {
...
- (BOOL)removeFromStylable:(id <VMGLStylable>)mapView error:(NSError * __nullable * __nullable)outError {
