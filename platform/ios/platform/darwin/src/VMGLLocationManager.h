...
@protocol VMGLLocationManagerDelegate;
 ...
 */
@protocol VMGLLocationManager <NSObject>
 ...
 */
@property (nonatomic, weak) id<VMGLLocationManagerDelegate> delegate;
 ...
 */
@protocol VMGLLocationManagerDelegate <NSObject>
...
/**
 ...
 default location manager.
 */
- (void)locationManager:(id<VMGLLocationManager>)manager
