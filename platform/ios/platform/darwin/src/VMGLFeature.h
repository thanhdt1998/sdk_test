 ...
 */
@protocol VMGLFeature <VMGLAnnotation>
 ...
 */
MGL_EXPORT
@interface MGLEmptyFeature : VMGLShape <VMGLFeature>
@end
 ...
 */
MGL_EXPORT
@interface MGLPointFeature : VMPointAnnotation <VMGLFeature>
@end
 ...
 */
MGL_EXPORT
@interface VMGLPolylineFeature : VMGLPolyline <VMGLFeature>
@end
 ...
 */
MGL_EXPORT
@interface MGLPolygonFeature : VMGLPolygon <VMGLFeature>
@end
 ...
 */
MGL_EXPORT
@interface MGLPointCollectionFeature : VMGLPointCollection <VMGLFeature>
@end
 ...
 */
MGL_EXPORT
@interface VMGLMultiPolylineFeature : VMGLMultiPolyline <VMGLFeature>
@end
 ...
 */
MGL_EXPORT
@interface MGLMultiPolygonFeature : VMGLMultiPolygon <VMGLFeature>
@end
 ...
 */
MGL_EXPORT
@interface MGLShapeCollectionFeature : VMGLShapeCollection <VMGLFeature>

@property (nonatomic, copy, readonly) NSArray<VMGLShape<VMGLFeature> *> *shapes;
