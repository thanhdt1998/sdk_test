...
@interface VMGLSource (Private)

/**
 Initializes and returns a source with a raw pointer to the backing store,
 associated with a style.
 */
- (instancetype)initWithRawSource:(mbgl::style::Source *)rawSource stylable:(nullable id <VMGLStylable>)stylable;
...
/**
 ...
 `MGLLayer`.
 */
- (void)addToStylable:(id <VMGLStylable>)mapView;
