...
FOUNDATION_EXTERN MGL_EXPORT VMGLExceptionName const MGLUnsupportedRegionTypeException;
 ...
 */
MGL_EXPORT
@interface VMGLOfflineStorage : NSObject

/**
 Returns the shared offline storage object.
 */
@property (class, nonatomic, readonly) VMGLOfflineStorage *sharedOfflineStorage;
 ...
 */
- (void)addPackForRegion:(id <VMOfflineRegion>)region withContext:(NSData *)context completionHandler:(nullable MGLOfflinePackAdditionCompletionHandler)completion;
