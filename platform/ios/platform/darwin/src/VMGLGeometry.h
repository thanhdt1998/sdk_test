 ...
 */
NS_INLINE VMGLCoordinateBounds MGLCoordinateBoundsMake(CLLocationCoordinate2D sw, CLLocationCoordinate2D ne) {
 ...
 */
NS_INLINE MGLCoordinateQuad MGLCoordinateQuadFromCoordinateBounds(VMGLCoordinateBounds bounds) {
    MGLCoordinateQuad quad;
...
NS_INLINE BOOL MGLCoordinateBoundsEqualToCoordinateBounds(VMGLCoordinateBounds bounds1, VMGLCoordinateBounds bounds2) {
...
NS_INLINE BOOL MGLCoordinateBoundsIntersectsCoordinateBounds(VMGLCoordinateBounds bounds1, VMGLCoordinateBounds bounds2) {
 ...
 */
NS_INLINE BOOL VMGLCoordinateInCoordinateBounds(CLLocationCoordinate2D coordinate, VMGLCoordinateBounds bounds) {
...
NS_INLINE MGLCoordinateSpan MGLCoordinateBoundsGetCoordinateSpan(VMGLCoordinateBounds bounds) {
 ...
 */
NS_INLINE VMGLCoordinateBounds MGLCoordinateBoundsOffset(VMGLCoordinateBounds bounds, MGLCoordinateSpan offset) {
    VMGLCoordinateBounds offsetBounds = bounds;
 ...
 */
NS_INLINE BOOL MGLCoordinateBoundsIsEmpty(VMGLCoordinateBounds bounds) {
...
NS_INLINE NSString *VMGLStringFromCoordinateBounds(VMGLCoordinateBounds bounds) {
...
NS_INLINE CGFloat VMGLRadiansFromDegrees(CLLocationDegrees degrees) {
    return (CGFloat)(degrees * M_PI) / 180;
}

/** Returns degrees, converted from radians. */
NS_INLINE CLLocationDegrees VMGLDegreesFromRadians(CGFloat radians) {
...
FOUNDATION_EXTERN MGL_EXPORT double VMGLZoomLevelForAltitude(CLLocationDistance altitude, CGFloat pitch, CLLocationDegrees latitude, CGSize size);
