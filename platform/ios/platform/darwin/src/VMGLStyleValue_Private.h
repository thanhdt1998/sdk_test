...
NS_INLINE mbgl::style::TransitionOptions MGLOptionsFromTransition(MGLTransition transition) {
    mbgl::style::TransitionOptions options { { VMGLDurationFromTimeInterval(transition.duration) }, { VMGLDurationFromTimeInterval(transition.delay) } };
    return options;
}
