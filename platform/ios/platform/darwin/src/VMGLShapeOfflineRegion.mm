...
- (instancetype)initWithStyleURL:(NSURL *)styleURL shape:(VMGLShape *)shape fromZoomLevel:(double)minimumZoomLevel toZoomLevel:(double)maximumZoomLevel {
...
- (instancetype)initWithOfflineRegionDefinition:(const mbgl::OfflineGeometryRegionDefinition &)definition {
    ...
    VMGLShape *shape = VMGLShapeFromGeoJSON(definition.geometry);
...
- (nullable instancetype)initWithCoder:(NSCoder *)coder {
    ...
    VMGLShape * shape = [coder decodeObjectForKey:@"shape"];
