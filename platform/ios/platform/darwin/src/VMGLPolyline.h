 ...
 */
MGL_EXPORT
@interface VMGLPolyline : VMGLMultiPoint <VMGLOverlay>
 ...
 */
MGL_EXPORT
@interface VMGLMultiPolyline : VMGLShape <VMGLOverlay>

/**
 An array of polygons forming the multipolyline.
 */
@property (nonatomic, copy, readonly) NSArray<VMGLPolyline *> *polylines;
