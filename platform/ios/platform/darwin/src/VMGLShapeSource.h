 ...
 */
MGL_EXPORT
@interface MGLShapeSource : VMGLSource
 ...
 */
- (instancetype)initWithIdentifier:(NSString *)identifier shape:(nullable VMGLShape *)shape options:(nullable NSDictionary<MGLShapeSourceOption, id> *)options NS_DESIGNATED_INITIALIZER;
 ...
 */
@property (nonatomic, copy, nullable) VMGLShape *shape;
