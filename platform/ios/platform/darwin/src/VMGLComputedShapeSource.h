...
FOUNDATION_EXTERN MGL_EXPORT VMGLExceptionName const MGLInvalidDatasourceException;
 ...
 */
@protocol VMComputedShapeSourceDataSource <NSObject>
 ...
 */
- (NSArray<VMGLShape <VMGLFeature> *>*)featuresInTileAtX:(NSUInteger)x y:(NSUInteger)y zoomLevel:(NSUInteger)zoomLevel;
...
/**
 ...
 @param zoomLevel Tile zoom level.
 */
- (NSArray<VMGLShape <VMGLFeature> *>*)featuresInCoordinateBounds:(VMGLCoordinateBounds)bounds zoomLevel:(NSUInteger)zoomLevel;
 ...
 */
MGL_EXPORT
@interface MGLComputedShapeSource : VMGLSource
...
/**
 ...
 @param options An `NSDictionary` of options for this source.
 */
- (instancetype)initWithIdentifier:(NSString *)identifier dataSource:(id<VMComputedShapeSourceDataSource>)dataSource options:(nullable NSDictionary<MGLShapeSourceOption, id> *)options;
