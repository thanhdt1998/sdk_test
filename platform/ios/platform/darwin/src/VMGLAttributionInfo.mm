...
@implementation VMGLAttributionInfo
...
+ (NSArray<VMGLAttributionInfo *> *)attributionInfosFromHTMLString:(nullable NSString *)htmlString fontSize:(CGFloat)fontSize linkColor:(nullable MGLColor *)linkColor {
    ...
    ^(id _Nullable value, NSRange range, BOOL * _Nonnull stop) {
        ...
        VMGLAttributionInfo *info = [[VMGLAttributionInfo alloc] initWithTitle:unlinkedTitle URL:value];
...
+ (NSAttributedString *)attributedStringForAttributionInfos:(NSArray<VMGLAttributionInfo *> *)attributionInfos {
    ...
    for (VMGLAttributionInfo *info in attributionInfos) {
...
{
    VMGLAttributionInfo *info = [[[self class] allocWithZone:zone] initWithTitle:_title
                                                                            URL:_URL];
 ...
 */
- (NSComparisonResult)subsetCompare:(VMGLAttributionInfo *)otherInfo {
...
- (void)growArrayByAddingAttributionInfo:(VMGLAttributionInfo *)info {
    ...
    [self enumerateObjectsUsingBlock:^(VMGLAttributionInfo * _Nonnull existingInfo, NSUInteger idx, BOOL * _Nonnull stop) {
...
- (void)growArrayByAddingAttributionInfosFromArray:(NSArray<VMGLAttributionInfo *> *)infos {
    for (VMGLAttributionInfo *info in infos) {
