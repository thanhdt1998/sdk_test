 ...
 */
MGL_EXPORT
@interface VMGLPolygon : VMGLMultiPoint <VMGLOverlay>
 ...
 */
@property (nonatomic, nullable, readonly) NSArray<VMGLPolygon *> *interiorPolygons;
...
/**
 ...
 @return A new polygon object.
 */
+ (instancetype)polygonWithCoordinates:(const CLLocationCoordinate2D *)coords count:(NSUInteger)count interiorPolygons:(nullable NSArray<VMGLPolygon *> *)interiorPolygons;
 ...
 */
MGL_EXPORT
@interface VMGLMultiPolygon : VMGLShape <VMGLOverlay>

/**
 An array of polygons forming the multipolygon.
 */
@property (nonatomic, copy, readonly) NSArray<VMGLPolygon *> *polygons;
